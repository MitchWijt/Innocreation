                    ...
                    <div class="pull-right">
                        <? if(\Illuminate\Support\Facades\Session::has("user_name")) { ?>
                                <div class="m-t-20 pull-right m-r-30 c-gray p-relative">
                                    <i class="@mobile popoverNotificationsMob @elsenotmobile popoverNotifications @endmobile zmdi zmdi-notifications c-gray f-25 c-pointer moreChev p-absolute" data-toggle="popover" data-content='<?= view("/public/shared/_popoverNotificationBox")?>' style="top: 23% !important; left: -20%"></i>
                                    <i class="zmdi zmdi-circle c-orange f-13 p-absolute <? if($counterMessages < 1) echo "hidden";?> notificationIdicator" style="top: 20%; left: -6.5%;"></i>
                                    <i class="zmdi zmdi-comment-text f-20 c-pointer p-absolute popoverMessages" data-toggle="popover" data-content='<?= view("/public/shared/messagesHeaderBox/_popoverBox")?>' style="top: 30% !important; left: -10%"></i>
