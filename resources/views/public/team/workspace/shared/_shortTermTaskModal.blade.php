...
<div class="shortTermTaskModalContainer">
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-sm-4 @mobile d-flex js-center @endmobile">
            ...
            <div class="@desktop col-sm-4 @elsemobile col-sm-4 @enddesktop">
                <div class="@desktop d-flex fd-column m-t-5 @elsemobile m-t-5 col-sm-12 @enddesktop">
                    <? if($shortPlannerTask->due_date != null) { ?>
                    <div class="d-flex fd-row js-center dueDateHover @mobile d-flex js-center @endmobile">
                    ...
                    <? } else { ?>
                        <div class="d-flex fd-row js-center dueDateHover">
            ...
            <div class="col-sm-4 m-t-10">
                <div class="row">
                    <div class="@mobile text-center col-5 p-r-0 @elsedesktop col-sm-5 p-r-0 @endmobile">
                        <p class="m-b-0 ">Priority:</p>
                    </div>
                    <div class="@mobile text-center col-7 @elsedesktop col-sm-7 @endmobile">
