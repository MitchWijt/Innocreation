            ...
            <div class="container-fluid p-0">
                ...
                <div class="row m-r-0">
                    <div class="@mobile col-12 @elsedesktop col-3 @endmobile p-l-15 p-r-0" style="border-right: 1px solid #77787a;">
                        ...
                        <? } ?>
                        <? if(\Illuminate\Support\Facades\Session::has("teamChatId")) { ?>
                            <input type="hidden" class="teamId" value="<?= \Illuminate\Support\Facades\Session::get("teamChatId")?>">
                        <? } else { ?>
                            <input type="hidden" class="teamId" value="0">
                        <? } ?>
                        ...
                        <form action="/searchChatUsers" class="searchChatUsersForm @mobile text-center @endmobile p-r-10 p-l-10" method="post">
                            ...
                            <input type="text" placeholder="Search in my chats..." class="searchChatUsers input m-t-20 form-control p-10" name="searchChatUsers">
                        </form>
                        ...
                        <div class="o-scroll chats" style="height: 72vh; position: relative;">
                            <? foreach($eachValue as $userChat) { ?>
                                ...
                                ?>
                                <div class="row m-t-10 p-t-10 p-b-10 m-r-0 c-pointer chatItem chat-<?= $userChat['userchat']->id?>" <? if($userChat['teamChat']) { ?> data-chat-id="0" data-team-id="<?= $userChat['userchat']->id?>" <? } else { ?> data-chat-id="<?= $userChat['userchat']->id?>" data-team-id="0" <? } ?> data-receiver-user-id="<?=$userChat['user']->id?>">
                                ...
                                <div class="col-sm-2 m-t-10 hidden actions">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7 p-l-0 p-r-10 sendBtn hidden">
                                            ...
                                            <button class="btn btn-inno btn-sm  btn-block sendUserMessage" data-chat-id="" data-team-id>Send</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
