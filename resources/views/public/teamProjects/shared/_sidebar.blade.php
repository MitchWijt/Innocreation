<div class="sidebar p-t-15" style="height: 200vh;">
    ...
    <? if(\Illuminate\Support\Facades\Session::has("team_id")) { ?>
        ...
        <div class="d-flex c-pointer">
            ...
            <div class="m-t-5 m-l-5 overflow-ellipsis" style="max-width: 150px;">
                <span class="bold f-19"><?= $team->team_name?></span>
            </div>
            <i class="zmdi zmdi-chevron-down f-25 c-black m-l-5 m-t-6"></i>
        </div>
