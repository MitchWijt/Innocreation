        ...
        <div class="instructions">
            <div class="container">
                <div class="sub-title-container p-t-20">
                    <h1 class="sub-title">How it works</h1>
                </div>
                <div class="hr"></div>
                <div class="row instructions-flex">
                    ...
                    <p class="instructions-text m-0">Create an account with your expertise(s)</p>
                </div>
                ...
                <div class="row instructions-flex-right p-b-20">
                    <p class="instructions-text m-b-0 m-r-20">Create or join a team and enjoy working together!</p>
                    <div class="circle-instructions">
        ...
        <div class="instructions-second ">
            <div class="container">
                <div class="row instructions-flex p-t-20">
                    <div class="circle-instructions-second">
                        <i style="font-size: 50px; padding-left: 1px;" class="material-icons social-icon-instructions">lightbulb_outline</i>
                    </div>
                    <p class="instructions-second-text m-0">Experience other people their ideas. And discuss ideas in the forum</p>
                </div>
                <div class="row instructions-flex-right ">
                    <p class="instructions-second-text m-b-0 m-r-20">Communicate easily with your team through the chat system</p>
                    <div class="circle-instructions-second">
                ...
                <div class="row instructions-flex-right">
                    <p class="instructions-second-text m-b-0 m-r-20">Sell your own team products in our shop</p>
                    <div class="circle-instructions-second">
