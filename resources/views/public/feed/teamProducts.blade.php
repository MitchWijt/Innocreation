                            ...
                            <div class="card-block">
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <h2 class="p-t-10 m-b-0"><?= $teamProduct->title?></h2>
                                ...
                                <div class="row">
                                    <div class="col-md-12 m-l-15 m-b-5 socials">
                                        ...
                                        <? } ?>
                                            ...
                                            <? } ?>
                                            <span><i class="zmdi zmdi-share f-20 shareTeamProduct toggleModal" data-toggle="modal" data-target="#shareTeamProductModal" data-id="<?= $teamProduct->id?>"></i></span>
                                        <? } else { ?>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <hr class="m-b-20">
                            <form action="/feed/shareTeamProduct" class="shareTeamProductUsersForm">
                                <div class="shareWithUsers hidden">
                                    <div class="row m-t-20">
                                        <div class="col-sm-6">
                                ...
                                <div class="shareProductMessage hidden">
                                    <textarea name="shareProductMessage" class="col-sm-12 input" rows="10">Check out this product! http://secret.innocreation.net/team-product/<?= $teamProduct->slug?></textarea>
